...
<div class="inner">
    ...
    <div class="section table_section">
            ...
            <table width="100%" border="0" class="listing form">
                <tr>
                    <td><b>Building Details at : </b></td> <td>  
                    
                        <input type='text' class="text" name="inputField1" value="<?php echo $acquisitiondate; ?>" id="inputField1" style="width:90px;"/>
...
<td style="color: black;"><nobr><a href="index.php?action=List_summary_6_list&id=1&categoryName=<?php echo $exp[0]; ?>&acquisitiondate=<?php echo $acquisitiondate; ?>"><?php echo $exp[0]; ?></a></nobr></td>	
<td><nobr><?php echo $exp[1]; ?></nobr></td>
<td><nobr><?php echo $exp[2]; ?></nobr></td>
<td align="right"><nobr><?php echo $exp[3]; ?></nobr></td>
<td style="text-align:right"><nobr><?php echo number_format((float)$exp[4], 2, '.', ','); ?></nobr></td>	
</tr> 
 <?php $i++; 
 $totqty = $totqty + $exp['3']; 
 $totvalue = $totvalue + $exp['4']; ?>
<?php } ?> 
</tbody>
	<tfoot>
	<tr>
