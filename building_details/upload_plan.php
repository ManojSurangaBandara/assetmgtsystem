                                        ...
                                        <table width="100%" border="0">
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">                                                    
													 <tr>
                                                        <td width="30%"><label>Plan Picture :</label></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php if($id==0){echo "Upload Land Plan";} else {echo "Upload Building Photo";} ?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
