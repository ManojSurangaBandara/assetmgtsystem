    ...
    <div class="inner">
        <div class="section">
            <div class="title_wrapper">
                <h2>Select Building Details For Modification</h2>
                                ...
                                <div class="sct_right">
                                                ...
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Search Items For Modification</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
                                    ...
                                    <ul class="system_messages">
                                        ...
                                        switch ($error) {
                                            case '0':
                                                ?>
                                                <li class="blue"><span class="ico"></span><strong class="system_title">Enter Serial No / Ledger No / Identification No and  press "Search Items For Modification" Button</strong></li>
                                                <?php
                                                break;
                                            case '1':
                                                ?>
