                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">                                                    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
																<span class="button send_form_btn"><span><span><?php if($id==0){echo "Upload Valuation Report";} else {echo "Upload Valuation Report";} ?></span></span><input name="" type="submit"/></span>      
															</div>
