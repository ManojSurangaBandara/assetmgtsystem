...
$("#get_category").click(function(){
   var querystring = {
			action: 'get_category_from_excel'
		}
...
$(document).on('click','.savebttn',function(){
	...
	var main_category = $('#main_category_'+id).val();
	var querystring = {
		id: id,
			  ...
			  <div class="section_content">
                <div class="sct">
					...
					<div class="table_wrapper">
                                ...
                                <tbody>
                                               ...
                                               foreach ($items as $exp) { ?>																
                                                    <tr>
														...
														<td><nobr><input class = "sname" type="text" value="<?php echo $exp['main_category']; ?>" id="main_category_<?php echo $exp['id']; ?>" style="text-align: left;" size="20" onClick="this.select();"></td>
							...
							<input class = "savebttn" id = "get_category" name="submit" type="submit" value="Get Main Category & Sub Category From Excel File"/>
