                            ...
                            <div class="sct_left">
                                <div class="sct_right">
                                    ...
                                    <form name="frm_add" method="post" id="frm_add" action="index.php" class="search_form general_form"> 
                                        <input type="hidden" name="action" value="change_surveyyear" />

                                        <table width="100%" border="0">
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    <tr>
                                                        <td width="30%"><label>Survey Year :	</label></td>
                                                        <td width="70%"><input type="text" class="text" name="survayyear"  id="survayyear" value="<?php echo $survayyear; ?>" style="width:50px"/>
                                                         </td>
                                                    </tr>
                                                    <tr>
                                                        <td><label> </label></td>
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php echo "Add Survay Year"; ?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
