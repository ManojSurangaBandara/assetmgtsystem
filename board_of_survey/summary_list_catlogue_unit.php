			...
			<table id="buyerTable" class="tablesorter" cellpadding="1" cellspacing="0" width="100%" border="1" BORDERCOLOR=skyblue style="font-size:11px;">
				...
				<?php $i = 1; 
				   ...
				   ?>																
						<tr>
							...
							<td title = "<?php echo $exp['description']; ?>"><nobr><?php echo substr($exp['description'],0,120); ?></nobr></td>
						...
						<?php 
						 $qty_onhand = $qty_onhand + $exp['qty_onhand'];
						 $qty_q1 = $qty_q1 + $exp['qty_q1'];
						 $qty_q2 = $qty_q2 + $exp['qty_q2'];
						 $qty_q3 = $qty_q3 + $exp['qty_q3'];
						 $qty_q4 = $qty_q4 + $exp['qty_q4'];
						 $qty_q5 = $qty_q5 + $exp['qty_q5'];
						 $qty_ledger = $qty_ledger + $exp['qty_ledger'];
						$i++; 
					} ?> 
				</tbody>
				  <tfoot>
				<tr>
				  <th id="total" colspan="4">Total :</th>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_onhand; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_q1; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_q2; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_q3; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_q4; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_q5; ?></nobr></td>
							<td style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;"><nobr><?php echo $qty_ledger; ?></nobr></td>
				</tr>
			   </tfoot>			
			</table>
			<form role="form" id="data" name="data" method="post" action="index.php" data-toggle="validator">
			<input type="hidden" name="action" value="print_opening_balance_summary" />
			<div class="col-md-1">
