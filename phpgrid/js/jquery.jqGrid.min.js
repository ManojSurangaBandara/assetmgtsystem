...
(function ($) {
            ...
            this._getOrder=function(data,by,dir,type, dfmt){
                ...
                if (type === 'float' || type=== 'number' || type=== 'currency' || type=== 'numeric') {
                    ...
                    findSortKey = function($cell) {
                        ...
                        // var datetime = $.jgrid.parseDate(dfmt, $cell);
                        // return datetime instanceof Date ? new Date("2011-01-10").getTime() : new Date("2011-01-10").getTime();
                    };
    ...
    **/ 
                    ...
                    if(cnt > 0) {
                        ...
                        if(o.keys===true) {
                            $(ind).bind("keydown",function(e) {
                                ...
                                if (e.keyCode === 13) {
                                    // alert("though e.keyCode === 13 line 9279");
                                    var ta = e.target;
    ...
    // alert("through saveRow");
            ...
            if (editable==="1") {
                // alert("through editable===1 line 9333");
                var cm;
                $('td[role="gridcell"]',ind).each(function(i) {
                    // alert("though cell : ".i);
                    cm = $t.p.colModel[i];
