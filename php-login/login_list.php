...
<div id="page">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <div id="Itmdiv">
                            <datalist id="loginnames" value="<?php echo $loginname; ?>">
                                <option value=""></option>
                                <?php foreach ($loginnames as $item) { ?>
                                    <option value="<?php echo $item; ?>">
                                        <?php echo $item; ?>
                                    </option>
                                <?php } ?>
                            </datalist>
                            <input type="text" class="text" name="loginname"  id="loginname" list="loginnames" value="<?php echo $loginname; ?>" style="width:200px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
