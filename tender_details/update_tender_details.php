                                ...
                                <div class="sct_right">
                                    <ul class="system_messages">
                                        ...
                                        switch ($error) {
                                            case '0':
                                                ?>
                                                <li class="blue"><span class="ico"></span><strong class="system_title">Enter Data and  press "Update Tender Details" Button</strong></li>
                                                <?php
                                                break;
                                            case '1':
                                                ?>
                                                <li class="green"><span class="ico"></span><strong class="system_title">Data Successfully Updated.</strong></li>
                                                <?php
                                                break;
                                            case '2':
                                                ?>
                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
														...
														<td width="70%"><input type="text" class="text" name="year"  id="year" value="<?php echo $year; ?>" style="width:30px"/>
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Update Tender Details</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
									...
									<form name="frm_Tender_add" method="post" id="frm_Tender_add" action="index.php" class="search_form general_form" onsubmit="return confirm('Are you sure you want to Delete this Record? <?php echo $tenderno; ?>');"> 
                                        <input type="hidden" name="action" value="delete_Tender_Details" />
                                                ...
                                                <table width="100%" border="0" class="listing form">
                                                    <tr>
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Delete Tender Details</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
                                                        </td>
                                                    </tr>
