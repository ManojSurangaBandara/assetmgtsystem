...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Select Disposals Details - Vehicles (Quick)</h2>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($items as $exp) { ?>																
                                                    <tr>
																...
																<input class = "savebttn" id = "<?php echo $exp['id']; ?>" name="submit" type="submit" value="Save" style="color: white; background-color: #008CBA;" hidden/></form></nobr></td>
																</tr>
																<?php $i++;?>
                                                <?php } ?> 
                                                            </tbody>
