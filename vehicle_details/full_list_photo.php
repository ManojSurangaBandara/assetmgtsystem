                    ...
                    <div class="sct_right">
                        <div class="sct_left">
                            <div class="sct_right">
                                <fieldset>
								<?php
echo "<a href='index.php?action=List_Details_photo&page1=1' class='paging'>First Page</a>";
                                    ...
                                    <div class="table_wrapper_inner">
                                        <table id="abc" cellpadding="1" cellspacing="0" border="1" BORDERCOLOR=skyblue style="font-size:11px;">
                                           <thead>
											...
											<th nowrap="nowrap"><nobr>Photo</nobr></th>
											...
											<tbody>
                                                        ...
                                                        <?php foreach ($items as $exp) { ?>																
                                                            ...
                                                            ?>>
																...
																<td><a href="<?php echo $exp['picpath']; ?>" ><img src="<?php echo $exp['picpath']; ?>" alt="" border=3 height=100 width=100></img></a></td>
