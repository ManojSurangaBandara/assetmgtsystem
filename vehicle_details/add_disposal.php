                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            <input type='text' class="text" name="disposedReason" value="<?php echo $disposedReason; ?>" id="disposedReason" style="width:300px;"/>
                                                            <?php echo $fields->getField('disposedReason')->getHTML(); ?><br /></td>    </td>
                                                    </tr>
													<tr>
                                                    <td width="30%"><label><?php echo $tList[30][$lang]?></label></td>
                                                        <td width="70%">
                                                            <input type='text' class="text" name="condemnation" value="<?php echo $condemnation; ?>" id="condemnation" style="width:300px;"/>
                                                        </td> 
                                                    </tr>
													<tr hidden>
													<td width="30%"><label><?php echo $tList[31][$lang]?></label></td>
                                                        <td width="70%">
                                                            <input type='text' class="text" name="destruction" value="<?php echo $destruction; ?>" id="destruction" style="width:300px;"/>
                                                        </td> 
                                                    </tr>
                                                    <tr>
                                                        <td><label> </label></td>
