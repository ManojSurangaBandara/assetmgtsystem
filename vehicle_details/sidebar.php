                                        ...
                                        case 5: 
                                            ...
                                            break;
												...
												case 30:
                                                    ...
                                                    if ($_SESSION['SESS_LEVEL'] == 1) {
														?> 
                                                        <li><a href="?index.php&action=Select_Items_For_displayvehicle">Select Display Vehicles Items</a></li>
                                                        <li><a href="?index.php&action=Selected_Items_For_displayvehicle">Selected List Display Vehicles</a></li>
                                                        <li><a href="?index.php&action=Confirm_Items_For_displayvehicle">Confirm Selected Display Vehicles</a></li> 
                                                        <li><a href="?index.php&action=approve_Items_For_displayvehicle">Approve Comfirmed Display Vehicles</a></li>
                                                        <li><a href="?index.php&action=displayvehicle_List">Display Vehicles List</a></li>
                                                        <li><a href="?index.php&action=displayvehicle_List_Inquiry">Display Vehicles Inquiry</a></li>
                                                        <?php 
													} elseif ($_SESSION['SESS_LEVEL'] == 3) {
                                                        ?>
                                                        <li><a href="?index.php&action=approve_Items_For_displayvehicle">Approve Comfirmed Display Vehicles</a></li>
												...
												case 37:
                                                    ?>
														<li><a href="?index.php&action=tender_full_list">Tender Full List</a></li>
                                                    <?php
                                                    break;
                                                default:
                                                    ?>
