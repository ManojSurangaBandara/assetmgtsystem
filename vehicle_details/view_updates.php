...
<div id="page">
    ...
    <div class="section table_section">
        ...
        <div class="title_wrapper">
            <h2>Vehicle Details Update Review</h2>
                                ...
                                <fieldset>
                                    ...
                                    <div class="table_wrapper_inner">
                                        <table id="myTable" class="tablesorter" cellpadding="1" cellspacing="0" width="100%" border="1" BORDERCOLOR=skyblue style="font-size:12px;">
											...
											<th>Disposal Approved  Date & Time</th>
											<th>Viewed - DAM</th>
											<th>DAM Comment</th>
                                            </tr>
											</thead>
                                            ...
                                            <?php foreach ($items as $exp) { ?>																
                                                <tr>
                                                    ...
                                                    <td><?php echo $exp['apprivedDate']; ?></td>
														<?php if ($exp['ApprovedDisposal'] = 1) {
														    $ApprovedDisposal = $exp['ApprovedDisposalDate'];
															} else {
															$ApprovedDisposal = "";
															}
														?>
													<td><?php echo $ApprovedDisposal; ?></td>													
														<?php if ($exp['view'] = 1) {
