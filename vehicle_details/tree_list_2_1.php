...
<td><nobr><a href="index.php?action=tree_list_2_1&id=3&assetunit=<?php echo $exp['assetunit']; ?>&catalogueno=<?php echo $exp['catalogueno']; ?>&itemDescription=<?php echo $exp['itemDescription']; ?>"><?php echo substr($exp['itemDescription'],0,40); ?></nobr></td>
