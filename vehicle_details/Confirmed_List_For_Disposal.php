...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Comfirmed Disposal Details - Vehicles</h2>
                                ...
                                <fieldset>
                                    <div class="table_wrapper_inner">
                                        <table id="abc" class="tablesorter" border="1" BORDERCOLOR=skyblue style="font-size:11px;">
											...
											<th><nobr><?php echo $tList[25][$lang]?></nobr></th>
											<th><nobr><?php echo $tList[26][$lang]?></nobr></th>
											<th><nobr><?php echo $tList[30][$lang]?></nobr></th>									
											<th><nobr><?php if($_SESSION['SESS_LEVEL'] == 1 || $_SESSION['SESS_LEVEL'] == 5) {?> Reject <?php } ?></nobr></th>
                                             </tr>
											</thead>                                                     
                                            <tbody>
                                                <?php $i = 1; 
                                                foreach ($Items as $exp) { ?>																
                                                    <tr id = "tr_<?php echo $exp['id']; ?>" <?php echo ($exp['confirmDisposal'] == 1) ? "style='color:Red'" : "";?>>
																...
																<input class = "reject" id = "r_<?php echo $exp['id']; ?>" name="submit" type="submit" value="Reject" style="color: white; background-color: #800000;"/></form>
																<?php } ?>
																</nobr></td>
																</tr>
																<?php $i++;?>
