                                ...
                                <div class="sct_right">
                                    <ul class="system_messages">
                                        ...
                                        switch ($error) {
                                            case '0':
                                                ?>
                                                <li class="blue"><span class="ico"></span><strong class="system_title">Press "Approve Button" to Approve Above Details</strong></li>
                                                <?php
                                                break;
                                            case '1':
                                                ?>
                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            <input hidden type="text" class="text" name="make"  id="make" value="<?php echo $make; ?>" style="width:100px; background-color:white; color: black" disabled/>
                                                            <input hidden type="text" class="text" name="modle"  id="modle" value="<?php echo $modle; ?>" style="width:150px; background-color:white; color: black" disabled/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Approve Vehicle Details</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
