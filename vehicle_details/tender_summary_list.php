...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Vehicle Tender Summary List</h2>
                                           ...
                                           <thead>
											...
											<tbody>
                                                        ...
                                                        <?php foreach ($items as $c) { 
															$type1 = tender_vehicledetails::tender_summary_cal($c['year'], $c['year_half'], 1);
															$type2 = tender_vehicledetails::tender_summary_cal($c['year'], $c['year_half'], 2);
														?>																
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
