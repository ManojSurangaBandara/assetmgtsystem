...
<div class="dropdown">
  ...
  <div class="dropdown-content">
		...
		<a href="index.php?action=add_vehicle_repair">Add Vehicle Repair Details</a>
  </div>
</div>
<div class="dropdown">
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
		...
		<a href="index.php?action=tender_details">Tender Details</a>
  </div>
</div>
<div class="dropdown">
  ...
  <div class="dropdown-content">
		...
		<a href="index.php?action=inquiry_summary_list">Inquiry Summary List</a>
  </div>
</div>
<div class="dropdown">
  ...
  <div class="dropdown-content">
		...
		<a href="index.php?action=approve_Items_For_loss">Approve Confirmed Lost & Damaged</a>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
		<a href="index.php?action=search_army_number">Search From Army Number</a>
		<a href="index.php?action=tender_full_list">Tender Vehicles Full List</a>
		<a href="index.php?action=tender_summary_list">Tender Vehicles Summery List</a>
		<a href="index.php?action=tender_summary_ordinance">Tender Vehicles Summery List - Ordinance</a>
  </div>
</div>
</div>