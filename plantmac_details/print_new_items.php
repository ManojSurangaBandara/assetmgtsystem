...
class PDF_NEW extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(1);
        // Title
        $this->Cell(0, 0, 'PLANT AND MACHINARY ASSETS - NEW ITEMS', 0, 0, 'L');
...
// $pdf_new = new PDF();
// Column headings
$header = array('S/N', 'C/N', 'Identification No.', 'Category', 'Description', 'Remarks', 'Catalogue No', 'Serial Number', 'Folio No', 'DOR', 'Unit Value');
...
//$pdf_new->Output('Plant and Machinary ' . '.pdf', 'D');
