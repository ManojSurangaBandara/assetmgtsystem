...
<div id="page">
    ...
    <div class="section table_section">
        ...
        <div class="title_wrapper"> 
			<h2>Plant & Machinery Details - Modify</h2>
                            ...
                            <div class="sct_right">
                                <fieldset>
                                    ...
                                    <div class="table_wrapper_inner">
                                        <table class="table table-condensed table-hover table-bordered table-striped table-hideable" cellpadding="1" cellspacing="0" width="100%" border="1" BORDERCOLOR=skyblue style="font-size:11px;">
                                                        ...
                                                        <?php foreach ($items as $exp) { ?>																
                                                            <tr>
																...
																<form name="add_form" id="add_form" class="add_form" action="." method="post">
																	...
																	<td style="width: 8%;"><input type="text" class="date" name="purchasedDate_<?php echo $exp['id']; ?>" id="purchasedDate_<?php echo $exp['id']; ?>" value="<?php echo $exp['purchasedDate']; ?>" style="width:80px;"></td>
																	<td style="width: 8%;"><input type="text" class="date" name="receivedDate_<?php echo $exp['id']; ?>" id="receivedDate_<?php echo $exp['id']; ?>" value="<?php echo $exp['receivedDate']; ?>" style="width:80px;"></td>
