...
<div id="page">
    ...
    <div class="section table_section">
			...
			<table width="100%" border="0" class="listing form">
				...
				<tr>
                    <td></td> 
					<td><input type="checkbox" name="ignore_units" value="1" <?php if ($ignore_units == 1) { echo "checked";}?> > Ignore Units</td>
					<td><input type="checkbox" name="ignore_month" value="1" <?php if ($ignore_month == 1) { echo "checked";}?> > Ignore Month</td>
				</tr>
                <tr>
                    <td></td>
                    <td>  
...
<td><a href="index.php?action=monthly_changes_2&id=2&year=<?php echo $year;?>&month=<?php echo $month;?>&catalogueno=<?php echo $exp['catalogueno'];?>&assetunit=<?php echo $exp['assetunit'];?>&ignore_month=<?php echo $ignore_month;?>"><font color="DarkBlue"><?php echo $exp['itemDescription']; ?></a></td>
...
<td><nobr><?php echo $exp['assetunit']; ?></nobr></td>	
<td><nobr><?php echo $exp['itemCategory']; ?></nobr></td>
<td><a href="index.php?action=monthly_changes_2&id=2&year=<?php echo $year;?>&month=<?php echo $month;?>&catalogueno=<?php echo $exp['catalogueno'];?>&assetunit=<?php echo $exp['assetunit'];?>"><font color="DarkBlue"><?php echo $exp['itemDescription']; ?></a></td>
<td><nobr><?php echo $exp['assetsno']; ?></nobr></td>
<td><nobr><?php echo $exp['catalogueno']; ?></nobr></td>
<td align="right"><nobr><?php echo $exp['cnt']; ?></nobr></td>
<td style="text-align:right"><nobr><?php echo number_format($exp['tot'], 2, '.', ','); ?></nobr></td>
