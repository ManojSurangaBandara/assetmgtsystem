    ...
    <div class="inner">
        <div class="section">
            <div class="title_wrapper">
                <h2><?php echo (isset($transfer) && $transfer == 1 ? 'Select Items For Transfer' : 'Select Items For Disposal')?> </h2>
                            ...
                            <div class="sct_left">
                                <div class="sct_right">
                                    <form name="frm_land_add" method="post" id="frm_land_add" action="index.php" class="search_form general_form"> 
                                        <input type="hidden" name="action" value="search_Disposals" />
                                                ...
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Search Disposal Item Details</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
                                    ...
                                    <ul class="system_messages">
                                        ...
                                        switch ($error) {
                                            case '0':
                                                ?>
                                                <li class="blue"><span class="ico"></span><strong class="system_title">Enter Data and  press "Search Disposal Item Details" Button</strong></li>
                                                <?php
                                                break;
                                            case '1':
                                                ?>
