...
<td><nobr><a href="index.php?action=lost_List_summary_tree_2_1&id=2&assetunit=<?php echo $exp['assetunit']; ?>&catalogueno=<?php echo $exp['catalogueno']; ?>&itemDescription=<?php echo $exp['itemDescription']; ?>"><?php echo substr($exp['itemDescription'],0,40); ?></nobr></td>
...
<div id="sidebar">
    ...
    <div class="easyui-panel" style="padding:5px">
        <ul id="tt2" class="easyui-tree">
            <li>
                <span><a href="index.php?action=lost_List_summary_tree_2&id=1">Plant & Machinery - Disposal </a></span>
                <ul>
                    <?php 
					$i=0;
					$j = 0;
					...
					<li id="2" data-options="state:'closed'">                        
						<span><a href="index.php?action=lost_List_summary_tree_2&id=2&unit=<?php echo $exp['mainCategory']; ?>"><?php echo $exp['mainCategory']; ?></a></span>
						<?php 
					   ...
					   $i=0;
						...
						?>
						<ul>
                            <li id="3" data-options="state:'closed'"><span><a href="index.php?action=lost_List_summary_tree_2&id=3&unit=<?php echo $exp['itemCategory']; ?>"><?php echo $exp['itemCategory']; ?></a></span>
                        
                       <?php 
					   $tem2 = $exp['itemCategory'];
					   } ?>
						<ul>
                            <li id="4"><a href="index.php?action=lost_List_summary_tree_2&id=4&unit=<?php echo $exp['itemDescription']; ?>"><?php echo $exp['itemDescription']; ?></a></li>
                        </ul>   
						<?php   
					   $i++;
					} ?>
