    ...
    <div class="inner">
        <div class="section">
            <div class="title_wrapper">
                <h2><?php if ($groupId == 0) {echo "ADD - Plant & Machinery Details";echo $_SESSION['SESS_PLACE'];} else {echo $identificationnoTem;} ?></h2>
...
<!--                                        <input type="hidden" name="identificationnoTem" value="<?php echo $identificationnoTem; ?>" />-->
                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  width="70%">
                                                            <div id="DSdiv">
                                                                <select name="itemDescription" id="itemDescription" onChange="getGSByDS('index.php?action=findCataloguenoByDescription&itemDescription=' + this.value)">
                                                                    <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            <div id="GSdiv">
                                                                <select name="catalogueno" id="catalogueno" onChange="getrequestitem('index.php?action=findAssetsnoByCatalogueno&catalogueno=' + this.value)">
                                                                    <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            ...
                                                            <input type="hidden" name="counterId" id="counterId" value="<?php if ($groupId == 0) {echo $counterId;} ?>"/>
                                                            </div>  
                                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php if($groupId==0){echo "Add Plant & Machinery Details";} else {echo "Update Plant & Machinery Details";} ?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
                                    ...
                                    <form name="frm_land_add" method="post" id="frm_land_add" action="index.php" class="search_form general_form" onsubmit="return confirm('Are you sure you want to Delete this Record? <?php echo $tenderno; ?>');"> 
