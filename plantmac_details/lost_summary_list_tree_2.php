...
<td><nobr><a href="index.php?action=lost_List_summary_tree_2_1&id=1&catalogueno=<?php echo $exp['catalogueno']; ?>&itemDescription=<?php echo $exp['itemDescription']; ?>"><?php echo substr($exp['itemDescription'],0,40); ?></a></nobr></td>
...
<div id="sidebar">
    ...
    <div class="easyui-panel" style="padding:5px">
        <ul id="tt2" class="easyui-tree">
            <li>
                <span><a href="index.php?action=lost_List_summary_tree_2&id=1">Plant & Machinery</a></span>
                <ul>
                    <?php 
					$i=0;
					$j = 0;
