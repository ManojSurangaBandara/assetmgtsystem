                            ...
                            <div class="sct_left">
                                <div class="sct_right">
                                    <form name="frm_land_add" method="post" id="frm_land_add" action="index.php" class="search_form general_form"> 
                                         <input type="hidden" name="action" value="ConfirmDisposalSave" />
                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            <input type="text" class="text" name="mainCategory"  id="mainCategory" value="<?php echo $itemCategory; ?>" style="width:300px; color: black" disabled/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="30%"><label><?php echo $tList[3][$lang]?></label></td>
                                                        <td width="70%">
                                                            <input type="text" class="text" name="itemCategory"  id="itemCategory" value="<?php echo $mainCategory; ?>" style="width:300px; color: black" disabled/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                  ...
                                                  <!--  <tr>
													...
													<?php } ?>
                                                                <tr>
                                                        <td width="30%"><label><?php echo (isset($transfer) && $transfer == 1 ? 'Confirm for Transfer' : 'Confirm for Disposal  :')?></label></td>
                                                        <td width="70%">
                                                            <input name="confirmDisposal" type="checkbox" value="1" <?php if($confirmDisposal==1) echo "checked=checked"; ?> > Select / Deselect
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Confirm Details</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
									...
									<form name="frm_land_add2" method="post" id="frm_land_add2" action="index.php" class="search_form general_form"> 
                                        <input type="hidden" name="action" value="ConfirmDisposalReject" />
                                        <input type="hidden" name="id" value="<?php echo $id; ?>" />
                                        <table width="100%" border="0">
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
													...
													<td width="30%"><label>&nbsp;</label></td>
                                                        ...
                                                        <td width="70%">
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span>Reject Disposal Request</span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
