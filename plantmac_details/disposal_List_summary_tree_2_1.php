...
<td><nobr><a href="index.php?action=Disposal_List_summary_tree_2_1&id=2&assetunit=<?php echo $exp['assetunit']; ?>&catalogueno=<?php echo $exp['catalogueno']; ?>&itemDescription=<?php echo $exp['itemDescription']; ?>"><?php echo substr($exp['itemDescription'],0,40); ?></nobr></td>
...
<div id="sidebar">
    ...
    <div class="easyui-panel" style="padding:5px">
        <ul id="tt2" class="easyui-tree">
            <li>
                <span><a href="index.php?action=Disposal_List_summary_tree_2&id=1">Plant & Machinery - Disposal </a></span>
                <ul>
                    <?php 
					$i=0;
					$j = 0;
