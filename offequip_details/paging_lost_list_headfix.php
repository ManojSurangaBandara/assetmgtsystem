...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Loss & Damaged Details List - Office Equipments</h2>
                    ...
                    <div class="sct_right">
                        <div class="sct_left">
                            <div class="sct_right">
                                <fieldset>
<?php
echo "<a href='index.php?action=loss_List&page1=1' class='paging'>First Page</a>";
for ($j=1; $j<=$total_pages; $j++) {
	echo "<a href='index.php?action=loss_List&page1=$j' class='paging'>$j</a>";
};
$last_page_no = $total_pages ? $total_pages : 1;
echo "<a href='index.php?action=loss_List&page1=$last_page_no'  class='paging'>Last Page</a>";
?>
