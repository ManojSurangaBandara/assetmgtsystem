            ...
            <div class="section">
                <div class="title_wrapper">
                    ...
                    switch ($slidebartype) {
						...
						case 28:
                            ?>
                            <h2><?php echo $slideBar[7][$lang]?></h2>
                            <span class="title_wrapper_left"></span>
                            <span class="title_wrapper_right"></span>
                            <?php
                            break;
                                            ...
                                            switch ($slidebartype) {
                                                ...
                                                case 11:
                                                    ...
                                                    <?php
													 if ($_SESSION['SESS_LEVEL'] == 1) {
                                                        ?>
                                                        <li><a href="?index.php&action=bulk_approved">Bulk Approve</a></li>
                                                    <?php
													 }
													break;
                                                case 12:
                                                ...
                                                case 4:
                                                    foreach ($Items as $Item) :
                                                        ?>
                                                        <li><a href="?index.php&action=Get_Issue_items&itemcode=<?php echo $Item['itemcode']; ?>" title="<?php echo get_ExpItem_name($Item['itemcode']); ?>"><?php echo $Item['itemcode']; ?> </a></li>            
                                                    <?php endforeach; ?>
                                                    <?php
                                                    break;
												case 5: //For Update Records
                                                    if (empty($Items)) {
                                                        ?>
                                                        <img src="<?php echo $logo; ?>" alt="A description of the picture" width="230" height="230" /> 
                                                    <?php
												...
												case 25:
                                                    ...
                                                    break;
												case 26:
                                                    if ($_SESSION['SESS_LEVEL'] == 1 || $_SESSION['SESS_LEVEL'] == 3) {
														?> 
														<li><a href="?index.php&action=Select_Items_For_Transfer"><?php echo $slideBar[18][$lang]?></a></li>
                                                        <li><a href="?index.php&action=Selected_Items_For_Transfer"><?php echo $slideBar[19][$lang]?></a></li>
														<li><a href="?index.php&action=ConfirmTransferSave"><?php echo $slideBar[20][$lang]?></a></li>														
												...
												case 27:
                                                    foreach ($Items as $Item) :
														?>
                                                        <li><a href="?index.php&action=search_transfer&id=<?php echo $Item['id']; ?>" title="<?php echo $Item['searchKey']; ?>"><?php echo $Item['searchKey']; ?></a></li>            
                                                    <?php 										
													endforeach; ?>
                                                    <?php
                                                    break;
												case 28:
                                                    foreach ($Items as $Item) :
														?>
														<li><a href="?index.php&action=Selected_Items_For_Transfer&id=<?php echo $Item['id']; ?>" title="<?php echo $Item['identificationno']; ?>"><?php echo $Item['identificationno']; ?> </a></li>           
                                                    <?php 										
													endforeach; ?>
                                                    <?php
                                                    break;
												case 29:
                                                    foreach ($Items as $Item) :
														?>
														<li><a href="?index.php&action=ConfirmTransferSave&id=<?php echo $Item['id']; ?>" title="<?php echo $Item['identificationno']; ?>"><?php echo $Item['identificationno']; ?> </a></li>           
                                                    <?php 										
													endforeach; ?>
                                                    <?php
                                                    break;
