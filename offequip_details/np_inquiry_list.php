...
<div id="page">
    <div class="section table_section">
        ...
        <div class="title_wrapper">
            <h2>Office Equipments Details List - Non Public</h2>
