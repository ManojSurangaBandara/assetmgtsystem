...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Office Equipments Details List - Non Public Items</h2>
                    ...
                    <div class="sct_right">
                        <div class="sct_left">
                            <div class="sct_right">
                                <fieldset>
<?php
echo "<a href='index.php?action=np_paging_list_headfix&page1=1' class='paging'>First Page</a>";
for ($j=1; $j<=$total_pages; $j++) {
	echo "<a href='index.php?action=np_paging_list_headfix&page1=$j' class='paging'>$j</a>";
};
$last_page_no = $total_pages ? $total_pages : 1;
echo "<a href='index.php?action=np_paging_list_headfix&page1=$last_page_no'  class='paging'>Last Page</a>";
?>
                                    <div class="table_wrapper_inner">
                                        <table id="abc" class="tablesorter" border="1" BORDERCOLOR=skyblue style="font-size:11px;">
											...
											<th><nobr>Cigas Asset No</nobr></th>
											<th><nobr>Cigas ID No.</nobr></th>
                                             </tr>
											</thead>                                                     
                                            <tbody>
                                                <?php  
