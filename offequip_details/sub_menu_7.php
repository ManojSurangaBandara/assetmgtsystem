...
<div class="dropdown">
  ...
  <div class="dropdown-content">
		...
		<?php } else { ?>
		 ...
		 <a href="?index.php&action=Select_Items_For_Disposal_quick">Select Items For Disposal</a>
		 <a href="?index.php&action=add_disposal_details_quick">Add Disposal Details</a>
		 ...
		 <a href="?index.php&action=confirm_items_for_disposal_quick">Confirm Items for Disposal</a>
