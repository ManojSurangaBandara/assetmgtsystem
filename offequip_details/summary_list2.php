...
<div class="inner">
    ...
    <div class="section table_section">
        <form action="." method="post" id="search_Expendable__form">
            <input type="hidden" name="action" value="List_summary2"/>
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td>  
						<!-- 
                        <input hidden type="checkbox" name="ExpToExcel" value="1" /> <?php echo $expexcel[$lang]?>
 

                        <input hidden type="checkbox" name="ExpToPdf" value="1" /> <?php echo $exppdf[$lang]?>
						-->
                    </td> 
                </tr>
            </table>
        ...
        <div class="title_wrapper">
            <h2><?php echo (isset($disposal) && $disposal == 1 ? 'Office Equipment  - Disposal List' : 'Office Equipment Details List') ?></h2>
...
<td style="text-align:right"><?php echo number_format($exp['tot'], 2, '.', ','); ?></td>	
</tr> 
 <?php $i++; 
