...
<div id="page">
    ...
    <div class="section table_section">
        <form action="." method="post" id="record_status">
            <input type="hidden" name="action" value="record_status"/>
        ...
        <div class="title_wrapper">
            <h2>Office Equipments Record Status</h2>
                                ...
                                <fieldset>
                                    ...
                                    <div class="table_wrapper_inner">
                                        <table id="myTable" class="tablesorter" cellpadding="1" cellspacing="0" width="100%" border="1" BORDERCOLOR=skyblue style="font-size:12px;">
											...
											<th><nobr>Confirmed</nobr></th>
                                            <th><nobr>Confirmed  Date & Time</nobr></th>
											<th><nobr>selectDisposal</nobr></th>
											<th><nobr>selectDisposalDate</nobr></th>
											<th><nobr>confirmDisposal</nobr></th>
											<th><nobr>confirmDisposalDate</nobr></th>
											<th><nobr>ApprovedDisposal</nobr></th>
											<th><nobr>ApprovedDisposalDate</nobr></th>
											<th><nobr>transfered</nobr></th>
											<th><nobr>ApprovedLoss</nobr></th>
                                            </tr>
											</thead>
											<tbody> 
                                            <?php $i = 1; ?>
                                            <?php foreach ($items as $exp) { ?>																
                                                <tr>
													...
													<td><nobr><?php echo $exp['apprived']; ?></nobr></td>
													...
													<td><nobr><?php echo $exp['transfered']; ?></nobr></td>
													<td><nobr><?php echo $exp['ApprovedLoss']; ?></nobr></td>												
                                                </tr>
                                                <?php $i++; ?>
                                            <?php } ?> 
                                            </tbody></table>
