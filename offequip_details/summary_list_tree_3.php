...
$(document).ready(function(){
    $('#oe').click(function(){
	 ...
	 function processResponse(data) {
        ...
        if(data == '')
            return;
        JSONToCSVConvertor(data, "Office Equipments " + value.itemCategory, true);
		} 
                });
		} 		
return false       
...
<?php
if ($id == 1){
echo "<a href='index.php?action=List_summary_tree_3&id=1&page1=1' class='paging'>First Page</a>";
...
<div id="sidebar">
    ...
    <div class="easyui-panel" style="padding:5px">
        <ul id="tt2" class="easyui-tree">
            <li>
                <span ><a href="index.php?action=List_summary_tree_3&id=1">Office Equipments</a></span>
                <ul>
                    <?php 
					$i=0;
					$j = 0;
					...
					<li id="2" data-options="state:'closed'">                        
					   ...
					   $tem2 = $exp['itemCategory'];
						...
						<ul>
                            <li id="4"><a href="index.php?action=List_summary_tree_3&id=4&itemCategory=<?php echo $exp['itemDescription']; ?>"><?php echo $exp['itemDescription']; ?></a></li>
                        </ul>   
						<?php   
					   $i++;
					} ?>
