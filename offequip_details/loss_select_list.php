...
<div id="page">
    ...
    <div class="section table_section">
        <div class="title_wrapper">
            <h2>Select Lost & Damaged Details - Office Equipments</h2>
                    ...
                    <div class="sct_right">
                        <div class="sct_left">
                            <div class="sct_right">
                                <fieldset>
									<?php
									echo "<a href='index.php?action=paging_list_headfix&page1=1' class='paging'>First Page</a>";
