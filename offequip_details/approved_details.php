                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                             <input type="text" class="text" name="fundtype"  id="fundtype" value="<?php echo ($fundtype == 1 ? 'NonPublic' : 'Public'); ?>" style="width:100px; background-color:white; color: black" disabled/>
                                                        </td>
                                                    </tr>
                                                    <tr>
