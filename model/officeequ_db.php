...
class OfficeEquDB {
	...
	private function validateDate1($date) {
		$d = DateTime::createFromFormat('Y-m-d', $date);
		return $d && $d->format('Y-m-d') == $date;
	}

    public static function getOfficeEqu() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
    ...
    public static function getFullDetails() {
		...
		$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno";
        try {
    ...
    public static function getFullDetailsUnit($assetunit) {
        ...
        $query = "SELECT DISTINCT catalogueno FROM officeequdetails WHERE".$querytext." order by catalogueno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
        ...
        $query = "SELECT ".$selection." FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getHasRecord($land) {
        ...
        $query = "SELECT count(1) as tot FROM officeequdetails
    ...
    public static function addOfficeEqu($plantMac) {
        $db = Database::getDB();
        ...
        $query = "INSERT INTO officeequdetails
        ...
        //         (assetscenter, assetunit, mainCategory, itemCategory, itemDescription, assetsno, newAssestno, catalogueno, identificationno, ledgerno, ledgerFoliono, eqptSriNo, , purchasedDate, quantity, capacity, unitValue, totalCost, receivedDate, Remarks)
        // VALUES
        // ('$assetscenter', '$assetunit', '$mainCategory', '$itemCategory', '$itemDescription', '$assetsno', '$newAssestno', '$catalogueno', '$identificationno', '$ledgerno', '$ledgerFoliono', '$eqptSriNo', '$purchasedDate', '$quantity', '$capacity', '$unitValue', '$totalCost', '$receivedDate', '$Remarks')";
    ...
    public static function getCounterId($assetunit, $catalogueno) {
        $db = Database::getDB();
        $query = "select max(counterId) as tot from officeequdetails where assetunit = '$assetunit' and catalogueno = '$catalogueno'";
        $result = $db->query($query);
        $row = $result->fetch();
        $count = $row['tot'];
        return $count;
    ...
    public static function getGroupId() {
        $db = Database::getDB();
        $query = 'select max(groupId) as tot from officeequdetails';
        $result = $db->query($query);
        $row = $result->fetch();
        $count = $row['tot'];
        $count = $count + 1;
    ...
    public static function getItemsNotApproved() {
		...
		$query = "SELECT identificationno, groupId, assetunit, assetscenter FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno";
		//$query = 'SELECT * FROM officeequdetails WHERE apprived = 0 and notapprived = 0 and transferReceivecenter is NULL order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function deleteItemsNotApproved() {
        ...
        $querytext = " apprived = 0 and notapprived = 0 and transferReceivecenter is NULL";
		$querytext = Database::unitsFilter($querytext);
		$query = "DELETE FROM officeequdetails WHERE".$querytext;
        $db->exec($query);
    }
  ...
  public static function getItemsApproveRejected() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE apprived = 0  and notapprived = 1 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getItemsApproved() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getDetailsByIdentificationno($identificationno) {
        $db = Database::getDB();
        $query = "select * from officeequdetails where identificationno = '$identificationno'";
        $result = $db->query($query);
        $row = $result->fetch();
        // $count = $row['tot'];
        return $row;
        ...
        $db = Database::getDB();
        $query = "select * from officeequdetails where id = '$id'";
        $result = $db->query($query);
        $row = $result->fetch();
        return $row;
    }
        ...
        $row = $result->fetch();
        $count = $row['groupId'];
        $query = "SELECT * FROM officeequdetails WHERE groupID = '$count' order by counterId";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function ApproveDetails($id, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET apprived = 1, approvedPerson = '$login', apprivedDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
        ...
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET notapprived = 1, notapprivedReason = '$notapprivedReason', approvedPerson = '$login', apprivedDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    } 
      ...
      public static function getDisposalItems($catalogueno, $searchby, $search) {
        ...
        switch ($searchby) {
            case 'Serial Number':
                $query = "SELECT id, identificationno as searchKey, assetscenter, assetunit FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 0 and ApprovedLoss = 0 and confirmDisposal = 0 and ApprovedDisposal = 0 and transfered = 0 and eqptSriNo LIKE '%$search%' order by protocolOrder, identificationno";
                break;
            case 'Ledger Number':
                $query = "SELECT id, identificationno as searchKey, assetscenter, assetunit FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 0 and ApprovedLoss = 0 and confirmDisposal = 0 and ApprovedDisposal = 0 and transfered = 0 and ledgerno LIKE '%$search%' order by protocolOrder, identificationno";
                break;
            case 'Identification Number':
                $query = "SELECT id, identificationno as searchKey, assetscenter, assetunit FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 0 and ApprovedLoss = 0 and confirmDisposal = 0 and ApprovedDisposal = 0 and transfered = 0 and identificationno LIKE '%$search%' order by protocolOrder, identificationno";
                break;
            case 'List All Items':
                $query = "SELECT id, identificationno as searchKey, assetscenter, assetunit FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 0 and ApprovedLoss = 0 and confirmDisposal = 0 and ApprovedDisposal = 0 and transfered = 0 and catalogueno = '$catalogueno' order by protocolOrder, identificationno";
                break;
			default:
				$query = "";
                break;
    ...
    public static function SelectDisposalSave($id, $selectDisposal, $disposedDate, $disposedReason, $condemnation, $destruction, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectDisposal = '$selectDisposal', disposedDate = '$disposedDate', disposedReason = '$disposedReason', condemnation = '$condemnation', destruction = '$destruction', selectDisposalPerson = '$login', selectDisposalDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function getToConfirmDisposalItems() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getToConfirmDisposalItemsSort() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, confirmDisposal, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getApprovedConfirmedItems() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and ApprovedLoss = 0 and ApprovedDisposal = 0 and transfered = 0 and confirmDisposal = 1 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getSelectedDisposalItems() {
        $db = Database::getDB();
      //  $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 0 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 0 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
		try {
            $statement = $db->prepare($query);
            $statement->execute();
    ...
    public static function ConfirmDisposalSave($id, $confirmDisposal, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET confirmDisposal = '$confirmDisposal', confirmDisposalPerson = '$login', confirmDisposalDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	...
	public static function ConfirmDisposalReject($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectDisposal = 0, confirmDisposal = 0, selectDisposalPerson = '', selectDisposalDate = '', confirmDisposalPerson = '', confirmDisposalDate = '', disposedDate = '', disposedReason = '', condemnation = '', destruction = '' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }	
    ...
    public static function getApproveDisposalItems($assetunit) {
        $db = Database::getDB();
        $query = "SELECT id, identificationno, assetscenter, assetunit FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and confirmDisposal = 1  and selectDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and assetunit = '$assetunit' order by protocolOrder, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
        ...
        $db = Database::getDB();
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and assetunit = '$assetunit' group by assetscenter, assetunit, catalogueno order by protocolOrder, catalogueno";	       
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getApproveDisposalItems_catlog_2($assetunit, $catalogueno) {
        $db = Database::getDB();
		$query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and assetunit = '$assetunit' and catalogueno = '$catalogueno' order by identificationno";	       
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function ApproveDisposalSave($id, $ApprovedDisposal, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET ApprovedDisposal = '$ApprovedDisposal', ApprovedDisposalPerson = '$login', ApprovedDisposalDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function getDisposalDetails() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and ApprovedLoss = 0 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getDisposalDetailsPaging($start_from, $per_page) {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and ApprovedLoss = 0 order by protocolOrder, identificationno LIMIT '.$start_from.', '.$per_page;
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function countTotalRecordsDisposalDetails() {
        $db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT count(*) as tot FROM officeequdetails WHERE".$querytext;        
        $result = $db->query($query);
        $row = $result->fetch();
        $count = $row['tot'];
        return $count;
    ...
    public static function deleteDetailsByGroupId($groupId) {
        $db = Database::getDB();
        $query = "DELETE FROM officeequdetails WHERE groupId = '$groupId'";
 	...
 	public static function deleteDetailsById($id) {
        $db = Database::getDB();
        $query = "DELETE FROM officeequdetails WHERE id = '$id'";
        $db->exec($query);
    }
	...
	public static function getInqDetails($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2, $checkAllowType, $allocation) {
       ...
       public static function getInqDisposalDetails($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2, $checkAllowType, $allocation) {
        ...
        if ($assetunit == '') {
		if ($inputField1 == '' || $inputField1 == '') {
            $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and  ApprovedDisposal = 1 and ".$column." LIKE '%$search%' order by identificationno";
                } else {
                $query = "SELECT * FROM officeequdetails WHERE (purchasedDate BETWEEN '$inputField1' AND '$inputField2') and fundtype = 0 and apprived = 1  and  ApprovedDisposal = 0 and " . $column . " LIKE '%$search%' order by identificationno";
            }
		} else {
		if ($inputField1 == '' || $inputField1 == '') {
            $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and  ApprovedDisposal = 1 and assetunit = '$assetunit' and ".$column." LIKE '%$search%' order by identificationno";
        } else {
             $query = "SELECT * FROM officeequdetails WHERE (purchasedDate BETWEEN '$inputField1' AND '$inputField2') and fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and assetunit = '$assetunit' and " . $column . " LIKE '%$search%' order by identificationno";   
            }
		}
        try {
            $statement = $db->prepare($query);
    ...
    public static function getDisposal_Inquiry($assetunit, $disposedYear) {
     $db = Database::getDB();
	 if ($disposedYear == "") {
		  $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and assetunit = '$assetunit' order by identificationno";
	 } elseif ($assetunit == "") {
		  $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and year(disposedDate) = '$disposedYear' order by assetunit, identificationno";
	 } else {
	 $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and assetunit = '$assetunit' and year(disposedDate) = '$disposedYear' order by identificationno";
	 }
		try {
            $statement = $db->prepare($query);
            $statement->execute();
   ...
   public static function getSearchText($column) {
        $db = Database::getDB();
        $query = "SELECT ".$column." as col, assetscenter, assetunit, protocoltext1, protocoltext2  FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by ".$column;
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
        ...
        if ($assetscenter == $assetunit) {
			$query = "SELECT count(1) as tot FROM officeequdetails WHERE assetunit = '$assetunit' and assetunit != presentLocation and fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
			//$query = "SELECT count(1) as tot FROM officeequdetails
            //      WHERE assetunit = '$assetunit' and assetunit != presentLocation and fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and transfered = 0";
			$result = $db->query($query);
			$row = $result->fetch();
			$count = ($row['tot'] > 0 ? 1 : 0);
		} else {
        ...
        $db = Database::getDB();
		$query = "SELECT * FROM officeequdetails
	...
	public static function ModificationAllows($groupId) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET apprived = 0 WHERE groupId ='$groupId'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function getSelectedTransferItems() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and transferSelect = 1 and transferToConfirm = 0 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function SelectTransferSave($id, $transferSelect, $transferToCenter, $transferToUnit, $transferToDetails, $transferToDate, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transferSelect = '$transferSelect', transferToCenter = '$transferToCenter', transferToUnit = '$transferToUnit', transferToDetails = '$transferToDetails', transferToDate = '$transferToDate' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	   ...
	   public static function getToConfirmTransferItems() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and transferSelect = 1 and transfered = 0 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function ConfirmTransferSave($id, $confirmDisposal, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transferToConfirm = '$confirmDisposal' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	...
	public static function ConfirmTransferReject($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transferSelect = 0, transferToCenter = '', transferToUnit = '', transferToDetails = '', transferToDate = '', transferToConfirm = 0 WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	...
	public static function getItemsNotTransfered($assetunit) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE transferToUnit ='$assetunit' and transferToConfirm = 1 and ApprovedLoss = 0 and transfered = 0 order by protocolOrder, identificationno";
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function addTransfer($assetscenter, $assetunit, $assetscenterFrom, $assetunitFrom, $identificationnofrom, $identificationnos, $receivedDate, $presentLocation, $Remarks, $counterId, $groupId) {
        $db = Database::getDB();
		$row = OfficeEquDB::getDetailsByIdentificationno($identificationnofrom);
			$query = "INSERT INTO officeequdetails
 ...
 VALUES ('".$assetscenter."', '".$assetunit."', '".$row['mainCategory']."', '".$row['itemCategory']."', '".$row['itemDescription']."', '".$row['assetsno']."', '".$row['newAssestno']."', '".$row['catalogueno']."', '".$identificationnos."', '".$row['ledgerno']."', '".$row['ledgerFoliono']."', '".$row['eqptSriNo']."', '".$row['purchasedDate']."', '".$row['quantity']."', '".$row['capacity']."', '".$row['unitValue']."', '".$row['totalCost']."', '".$receivedDate."', '".$Remarks."', '".$counterId."', '".$groupId."', 1, '".$presentLocation."', '".$row['acquisitionInstitute']."', '".$assetscenterFrom."', '".$assetunitFrom."', '".$identificationnofrom."', now())";
        $row_count = $db->exec($query);
		if ($row_count == 1) {
			$query = "UPDATE officeequdetails SET transfered = 1, transferReceivecenter = '$assetscenterFrom', transferReceiveunit = '$assetunitFrom', transferReceiveidentificationno = '$identificationnofrom' WHERE id = ".$row['id'];
			$count = $db->exec($query);
	...
	public static function getItemsNotApprovedTransfer() {
        $db = Database::getDB();
        $query = 'SELECT * FROM officeequdetails WHERE apprived = 0 and notapprived = 0 and ApprovedLoss = 0 and transferReceivecenter is NOT NULL order by protocolOrder, identificationno';
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function Savesorderwithcenter($sorderwithcenter, $identificationno) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET sorderwithcenter = '$sorderwithcenter' WHERE identificationno ='$identificationno'";
        $count = $db->exec($query);
        return $count;
		}
    public static function view_update($assetscenter, $assetunit) {
        ...
        $query = "SELECT groupId, assetscenter, assetunit, identificationno, itemDescription, sysdate, apprivedDate, view, viewdate, viewperson, damcomment FROM officeequdetails".$querytext." order by protocolOrder, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function view_dam($groupId, $login, $damcomment) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET view = 1, viewperson = '$login', viewdate = now(), damcomment = '$damcomment' WHERE groupId ='$groupId'";
        $count = $db->exec($query);
        return $count;
    }
	public static function picpath($groupId, $Filename) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET picpath = '$Filename' WHERE groupId ='$groupId'";
        $count = $db->exec($query);
        return $count;
    } 
    public static function getpicById($identificationno) {
        $db = Database::getDB();
        $query = "select picpath from officeequdetails where identificationno = '$identificationno'";
        $result = $db->query($query);
        $row = $result->fetch();
        return $row;
    }
    ...
    public static function getInqDetails3($assetscenter, $assetunit) {
        ...
        $query = "SELECT * FROM officeequdetails WHERE".$querytext." order by identificationno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getSummaryDetails($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetscenter, assetunit, catalogueno order by protocolOrder, catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getSummaryDetails2($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetscenter, assetunit, itemCategory order by protocolOrder, itemCategory";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getSummaryDetails3($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetscenter, assetunit, mainCategory order by protocolOrder, mainCategory";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getNotConfirmDetails($assetscenter, $assetunit, $column, $search, $inputField1, $inputField2) {
		$db = Database::getDB();
		$querytext = " apprived = 0 and ApprovedLoss = 0";
		if ($assetscenter) {
			$querytext = $querytext." and  assetscenter = '$assetscenter'"; }
		if 	($assetunit) {
			$querytext = $querytext." and  assetunit = '$assetunit'"; }
    ...
    public static function countRecords($assetunit) {
        $db = Database::getDB();
        $query = "SELECT count(*) as tot FROM officeequdetails
    ...
    public static function getItemsNotApprovedAll() {
        $db = Database::getDB();
        $querytext = " apprived = 0 and notapprived = 0 and ApprovedLoss = 0 and transferReceivecenter is NULL";
		$querytext = Database::unitsFilter($querytext);
		//if ($_SESSION['SESS_LEVEL'] == 6 || $_SESSION['SESS_LEVEL'] == 7 || $_SESSION['SESS_LEVEL'] == 8) {
        //     $assetunit = $_SESSION['SESS_PLACE'];
		//	 $querytext = $querytext." and  assetunit = '$assetunit'"; }   
    ...
    public static function updateserialno($id, $ledgerFoliono, $eqptSriNo, $purchasedDate, $receivedDate, $natureOwnership, $unitValue, $presentLocation) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET ledgerFoliono = '$ledgerFoliono', eqptSriNo = '$eqptSriNo', purchasedDate = '$purchasedDate', receivedDate = '$receivedDate', natureOwnership = '$natureOwnership', unitValue = '$unitValue', presentLocation = '$presentLocation' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    public static function zero_value_Records($assetunit) {
        $db = Database::getDB();
        $query = "SELECT *, COUNT(*) as cnt FROM officeequdetails WHERE assetunit = '$assetunit' and fundtype = 0 and apprived = 1 and unitValue = 0 GROUP BY catalogueno order by protocolOrder, counterID";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function Savesprotocol($protocoltext1, $protocoltext2, $protocol, $identificationno) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET protocoltext1 = '$protocoltext1', protocoltext2 = '$protocoltext2', protocolOrder = '$protocol' WHERE identificationno ='$identificationno'";
        $count = $db->exec($query);
        return $count;
		}
	public static function Addprotocol($protocoltext1, $protocoltext2, $protocol, $assetunit) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET protocoltext1 = '$protocoltext1', protocoltext2 = '$protocoltext2', protocolOrder = '$protocol' WHERE assetunit ='$assetunit'";
        $count = $db->exec($query);
        return $count;
		}
	    public static function getDetailsUnit($assetunit) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and assetunit = '$assetunit' order by protocolOrder, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getSummaryDetailsCategory($itemDescription) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetunit, catalogueno order by protocolOrder, catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
   ...
   INNER JOIN (SELECT eqptSriNo
               FROM   officeequdetails
               GROUP  BY eqptSriNo
               HAVING COUNT(id) > 1) dup
           ON officeequdetails.eqptSriNo = dup.eqptSriNo';
	...
	public static function change_assets_unit_name($oldassetunit, $newassetunit, $identification) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET assetunit = '$newassetunit' WHERE assetunit ='$oldassetunit'";
        $count = $db->exec($query);
		
		$query = "UPDATE officeequdetails SET identificationno = SUBSTRING(identificationno, 12) WHERE assetunit ='$newassetunit'";
        $count = $db->exec($query);
		
		$query = "UPDATE officeequdetails SET identificationno = CONCAT('$identification', identificationno) WHERE assetunit ='$newassetunit'";
        $count = $db->exec($query);
    ...
    public static function getDetailsUnitAll($assetunit) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE assetunit = '$assetunit' order by protocolOrder, counterID";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function deleteDetailsAll($assetunit) {
        $db = Database::getDB();
        $query = "DELETE FROM officeequdetails WHERE assetunit = '$assetunit'";
        $count = $db->exec($query);
		return $count;
    }
	public static function summaryRecords($assetunit) {
        $db = Database::getDB();
        $query = "SELECT sum(unitValue) as tot FROM officeequdetails
	...
	public static function summaryRecords_2() {
        $db = Database::getDB();
        $query = "SELECT count(1) as cnt, sum(unitValue) as tot FROM officeequdetails
    ...
    public static function reorder_id($assetunit, $catalogueno) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE assetunit = '$assetunit' and catalogueno = '$catalogueno' order by id";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getCatalogueno($assetunit) {
        $db = Database::getDB();
        $query = "SELECT DISTINCT catalogueno FROM officeequdetails WHERE assetunit = '$assetunit' order by catalogueno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function reorder_id_save($id, $identificationno, $counterId) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET identificationno = '$identificationno', counterId = '$counterId' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
		}
    public static function delete_not_confirm($assetunit, $catalogueno) {
        $db = Database::getDB();
        $query = "DELETE FROM officeequdetails WHERE assetunit = '$assetunit' and catalogueno = '$catalogueno' and apprived = 0";
        $count = $db->exec($query);
		return $count;
    }
    public static function getFullDetails_ledger() {
		...
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, mainCategory, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function getCataloguenos() {
        $db = Database::getDB();
        $query = "SELECT DISTINCT catalogueno FROM officeequdetails order by catalogueno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function get_catalogueno_dtls($catalogueno) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE catalogueno = '$catalogueno' order by id";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function serialno_replace_with_dash($catalogueno) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET eqptSriNo = '-' WHERE catalogueno ='$catalogueno'";
        $count = $db->exec($query);
        return $count;
		}
	public static function change_Catalogno_save($id, $identificationno, $catalogueno2, $itemDescription) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET identificationno = '$identificationno', catalogueno = '$catalogueno2' , itemDescription = '$itemDescription' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
		}
	public static function get_catalogueno_summary($catalogueno) {
        $db = Database::getDB();
        $query = "SELECT count(*) as cnt, sum(unitValue) as tot FROM officeequdetails
                  WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and catalogueno = '$catalogueno' ";
        $result = $db->query($query);
        $row = $result->fetch();
        return $row;	
	}
	public static function get_catalogueno_summary_1() {
		...
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by catalogueno order by catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function get_itemCategory_summary($itemCategory) {
        $db = Database::getDB();
        $query = "SELECT count(*) as cnt, sum(unitValue) as tot FROM officeequdetails
                  WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and itemCategory = '$itemCategory'";
        $result = $db->query($query);
        $row = $result->fetch();
        return $row;	
	}
	...
	$db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT mainCategory, itemCategory, protocoltext1, protocoltext2, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by itemCategory order by catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	$db = Database::getDB();
		...
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT mainCategory, itemCategory, itemDescription, assetsno, catalogueno, protocoltext1, protocoltext2, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by catalogueno order by catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function get_catalogueno_summary_1_unit($catalogueno) {
		...
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetunit order by protocolOrder, counterID";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	$db = Database::getDB();
		...
		$querytext = Database::unitsFilter($querytext);			
		if ($protocol == 1) {
			$query = "SELECT assetunit, itemCategory, itemDescription, assetsno, catalogueno, protocoltext1, protocoltext2, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetunit order by protocolOrder, counterID";	
		} else if ($protocol == 2) {
			$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by counterID";			
		}
        try {
            $statement = $db->prepare($query);
            $statement->execute();
	...
	$db = Database::getDB();
		...
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT assetunit, mainCategory, itemCategory, itemDescription, assetsno, catalogueno, protocoltext1, protocoltext2, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetunit order by protocolOrder, counterID";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function update_psos_allow($itemCategory, $DGGS, $DOPS, $DTRG, $DPLAN, $DIT, $CFE, $CSO, $DGSPORTS, $DSPORTS, $AG, $DGAHS, $DAMS, $DADS, $DAMPS, $DAMM, $QMG, $DAQ, $DST, $DES, $MGO, $DOS, $DEME, $DGINF) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET DGGS = '$DGGS', DOPS = '$DOPS', DTRG = '$DTRG', DPLAN = '$DPLAN', DIT = '$DIT', CFE = '$CFE', CSO = '$CSO', DGSPORTS = '$DGSPORTS', DSPORTS = '$DSPORTS', AG = '$AG', DGAHS = '$DGAHS', DAMS = '$DAMS', DADS = '$DADS', DAMPS = '$DAMPS', DAMM = '$DAMM', QMG = '$QMG', DAQ = '$DAQ', DST = '$DST', DES = '$DES', MGO = '$MGO', DOS = '$DOS', DEME = '$DEME', DGINF = '$DGINF' WHERE itemCategory ='$itemCategory'";
        $count = $db->exec($query);
        return $count;
		}
    ...
    public static function ca_no_err_list() {
		...
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT officeequdetails.* FROM officeequdetails JOIN classificationlist ON officeequdetails.catalogueno = classificationlist.catalogueno and  officeequdetails.itemDescription != classificationlist.itemDescription order by protocolOrder, identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function loss_select_save($id, $selectLoss, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectLoss = '$selectLoss', selectLossPerson = '$login', confirmLossDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function loss_confirm_save($id, $confirmLoss, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET confirmLoss = '$confirmLoss', selectLossPerson = '$login', confirmLossDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    public static function loss_reject_save($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectLoss = 0, confirmLoss = 0, selectLossPerson = '' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function loss_approve_save($id, $ApprovedLoss, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET ApprovedLoss = '$ApprovedLoss', selectLossPerson = '$login', confirmLossDate = now() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function save_loss_details($id, $lossedDate, $lossedReason) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET lossedDate = '$lossedDate', lossedReason = '$lossedReason' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	public static function countTotalRecords_loss() {
	 ...
	 public static function min_max_values() {
		...
		//$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and selectLoss = 1 and ApprovedLoss = 0";
		//$querytext = Database::unitsFilter($querytext);
        $query = "SELECT mainCategory, itemCategory, itemDescription, catalogueno, max(unitValue) as mx, min(unitValue) as mn FROM officeequdetails group by catalogueno order by catalogueno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function Confirmed_For_Disposal() {
        $db = Database::getDB();
       $query = 'SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 order by protocolOrder, identificationno';
	   try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function record_status($assetscenter, $assetunit) {
        ...
        $query = "SELECT * FROM officeequdetails".$querytext." order by protocolOrder, identificationno";
         try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getDisposalDetailsSummary() {
        ...
        $query = "SELECT *, count(catalogueno) as qty FROM officeequdetails WHERE year(disposedDate) = ".$currentYear." and fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 group by catalogueno order by catalogueno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function get_send_ordinance() {
		...
		//$querytext = Database::unitsFilter($querytext); 
		$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, counterID";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function send_ordinance_save($id, $selectLoss, $ordinance_send_date, $ordinance) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET select_send_ordinance = '$selectLoss', ordinance_send_date = '$ordinance_send_date', ordinance = '$ordinance' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    public static function get_receive_ordinance($assetunit) {
        $db = Database::getDB();
        $querytext = " assetunit = '$assetunit' and fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and select_send_ordinance = 1 and confirm_receive_ordinance = 0";
		$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, counterID";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
    ...
    public static function receive_ordinance_save($id, $selectLoss, $ordinance_receive_date) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET confirm_receive_ordinance = '$selectLoss', ordinance_receive_date = '$ordinance_receive_date' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	...
	$db = Database::getDB();
		...
		$querytext = Database::unitsFilter($querytext);			
		$query = "SELECT assetunit, mainCategory, itemCategory, itemDescription, assetsno, catalogueno, eqptSriNo, purchasedDate, receivedDate, unitValue, protocoltext1, protocoltext2 FROM officeequdetails WHERE".$querytext." order by protocolOrder, counterID";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	$db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and itemCategory = '$itemcategory'";		
		$query = "SELECT itemCategory, itemDescription, catalogueno, eqptSriNo, Year(purchasedDate) as pyear, unitValue FROM officeequdetails WHERE".$querytext." order by catalogueno, receivedDate";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
	...
	$db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";		
		$query = "SELECT DISTINCT itemCategory FROM officeequdetails WHERE".$querytext." order by catalogueno, receivedDate";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();			
	...
	$db = Database::getDB();
		...
		$querytext = Database::unitsFilter($querytext);			
		//$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno LIMIT ".$start_from.", ".$per_page;
		$query = "SELECT assetunit, mainCategory, itemCategory, itemDescription, assetsno, catalogueno, eqptSriNo, purchasedDate, receivedDate, unitValue, protocoltext1, protocoltext2 FROM officeequdetails WHERE".$querytext." order by protocolOrder, counterID LIMIT ".$start_from.", ".$per_page;		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function monthly_changes_iu($year, $month, $ignore_month) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by catalogueno order by protocolOrder, catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function monthly_changes_cata($year, $month, $catalogueno, $ignore_month) {
		...
		$query = "SELECT *, count(*) as cnt, sum(unitValue) as tot FROM officeequdetails WHERE".$querytext." group by assetunit order by protocolOrder, catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function monthly_changes_cata_unit($year, $month, $catalogueno, $assetunit, $ignore_month) {
		...
		$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by catalogueno";		
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function undo_Disposal_save($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectDisposal = 0, selectDisposalPerson = '', selectDisposalDate = '', confirmDisposal = 0, confirmDisposalPerson = '', confirmDisposalDate = '', ApprovedDisposal = 0, ApprovedDisposalPerson = '', ApprovedDisposalDate = '', disposedReason = '', disposedDate = '' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
	...
	public static function update_dam_controller($assetunit, $dam_controller) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET dam_controller = '$dam_controller' WHERE assetunit ='$assetunit'";
        $count = $db->exec($query);
        return $count;
		}
	public static function update_cigas_1($catalogueno, $cigas_assetno) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET cigas_assetno = '$cigas_assetno' WHERE catalogueno ='$catalogueno' and cigas_idno = ''";
        $count = $db->exec($query);
        return $count;
		}
    public static function update_cigas_2() {
        $db = Database::getDB();
        $query = "SELECT id, cigas_assetno FROM officeequdetails WHERE cigas_idno = '' order by cigas_assetno, protocolOrder, id";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function update_cigas_3($id, $cigas_idno) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET cigas_idno = '$cigas_idno', cigas_transferdate = CURDATE() WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
		}
    public static function getFullDetails_cigas($start_from, $per_page) {
		...
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT newAssestno, cigas_assetno, cigas_idno, assetunit, purchasedDate, itemCategory, itemDescription, unitValue, identificationno FROM officeequdetails WHERE".$querytext." order by cigas_assetno, protocolOrder, id LIMIT ".$start_from.", ".$per_page;
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getFullDetails_cigas_all() {
		...
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and transfered = 0 and ApprovedLoss = 0";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT newAssestno, cigas_assetno, cigas_idno, assetunit, purchasedDate, itemCategory, itemDescription, unitValue, identificationno FROM officeequdetails WHERE".$querytext." order by assetunit, protocolOrder, id";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function date_range_changes($receivedDate_from, $receivedDate_to, $display_type) {
		...
		if ($display_type == 0) {
			...
			$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, catalogueno";
		}
		try {
            $statement = $db->prepare($query);
            $statement->execute();
    ...
    public static function disband_all($unit) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transfered = 2, transferToDate = now() WHERE transfered = 0 and assetunit ='$unit'";
        $count = $db->exec($query);
        return $count;
    }
    public static function disband_one($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transfered = 2, transferToDate = now() WHERE transfered = 0 and id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function disband_all_undo($unit) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transfered = 0, transferToDate = now() WHERE transfered = 2 and assetunit ='$unit'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function getCatalogue_cigas_getmaxno($cigas_assetno) {
        $db = Database::getDB();
		$query = "SELECT id, cigas_assetno, cigas_idno FROM officeequdetails WHERE cigas_assetno = '$cigas_assetno' order by id DESC";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getFullDetails_cigas_date($start_from, $per_page) {
        $db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and transfered = 0 and ApprovedLoss = 0 and cigas_transferdate = CURDATE()";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT newAssestno, cigas_assetno, cigas_idno, assetunit, purchasedDate, itemCategory, itemDescription, unitValue, identificationno FROM officeequdetails WHERE".$querytext." order by cigas_assetno, protocolOrder, id LIMIT ".$start_from.", ".$per_page;
        try {
            $statement = $db->prepare($query);
	...
	public static function countTotalRecords_cigas_date() {
        $db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and cigas_transferdate = CURDATE()";
		$querytext = Database::unitsFilter($querytext);
        $query = "SELECT count(*) as tot FROM officeequdetails WHERE".$querytext;
        $result = $db->query($query);
        $row = $result->fetch();
 ...
 public static function RejectDisposalSave($id) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET confirmDisposal = 0, selectDisposal = 0 WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    ...
    public static function year_changes($year) {
		$db = Database::getDB();
		$querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0";
		if ($ignore_month == 0) {
			$querytext = $querytext." and  year(purchasedDate) = '$year' and month(purchasedDate) = '$month'";
    ...
    public static function select_transfer_quick($id, $transferSelect, $transferToCenter, $transferToUnit, $transferToDetails, $transferToDate) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET transferSelect = '$transferSelect', transferToConfirm = '$transferSelect', transferToCenter = '$transferToCenter', transferToUnit = '$transferToUnit', transferToDetails = '$transferToDetails', transferToDate = '$transferToDate' WHERE id ='$id'";
        $count = $db->exec($query);
        return $count;
    }
    public static function disposal_select_save_quick($id, $selectDisposal, $login) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET selectDisposal = '$selectDisposal', selectDisposalPerson = '$login', selectDisposalDate = now() WHERE id ='$id'";
		$count = $db->exec($query);
        return $count;
    }
    public static function disposal_details_save_quick($id, $disposedDate, $disposedReason, $condemnation) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET disposedDate = '$disposedDate', disposedReason = '$disposedReason', condemnation = '$condemnation' WHERE id ='$id'";
		$count = $db->exec($query);
        return $count;
    }
    public static function getItemsNotApproved_all() {
        $db = Database::getDB();
        $querytext = " apprived = 0 and notapprived = 0 and transferReceivecenter is NULL";
		$querytext = Database::unitsFilter($querytext);
		$query = "SELECT * FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno";
    ...
    public static function disposal_details_save_quick_all($assetunit, $disposedDate, $disposedReason, $condemnation) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET disposedDate = '$disposedDate', disposedReason = '$disposedReason', condemnation = '$condemnation' WHERE assetunit = '$assetunit' and fundtype = 0 and apprived = 1 and selectDisposal = 1 and confirmDisposal = 0 and ApprovedDisposal = 0 and ApprovedLoss = 0";
		$count = $db->exec($query);
        return $count;
    }
	public static function add_Board_report($assetunit) {
        $db = Database::getDB();
	    $querytext = " fundtype = 0 and apprived = 1 and ApprovedDisposal = 0 and ApprovedLoss = 0 and transfered = 0 and  assetunit = '$assetunit'";
		$query = "SELECT catalogueno, SUM(unitValue) AS total, COUNT(*) as cnt, GROUP_CONCAT(id) as ids_array FROM officeequdetails WHERE".$querytext." GROUP BY catalogueno order by catalogueno";
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function add_Board_report_disposal($assetunit, $currentYear, $catalogueno) {
        ...
        $query = "SELECT SUM(unitValue) AS total, COUNT(*) as cnt, GROUP_CONCAT(id) as ids_array FROM officeequdetails WHERE".$querytext;
        $result = $db->query($query);
        $row = $result->fetch();
        return $row;
    }
	...
	public static function board_report_summary_view_details($id){
		...
		$result = $db->query($query);
        $row = $result->fetch();
		$query = "SELECT * FROM officeequdetails WHERE id in (".$row['ids_array'].")";
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function change_unit_name($assetscenter, $assetunit, $assetscenter1, $assetunit1, $CentreID, $CentreIDold) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET assetscenter = '$assetscenter1', assetunit = '$assetunit1', presentLocation = '$assetunit1', identificationno = REPLACE(identificationno, '$CentreIDold', '$CentreID') WHERE assetunit ='$assetunit' and assetscenter = '$assetscenter'";
        $count = $db->exec($query);
        return $count;
		}
	public static function change_unit_name1($assetscenter, $assetunit, $assetscenter1, $assetunit1, $CentreID, $CentreIDold) {
        $db = Database::getDB();
        $query = "UPDATE officeequdetails SET identificationno = CONCAT('$CentreID', SUBSTR(identificationno,12,19)) WHERE assetunit ='$assetunit' and assetscenter = '$assetscenter'";
        $count = $db->exec($query);
        return $count;
		}
    ...
    public static function getDisposalDetails_year($assetunit, $currentYear) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE fundtype = 0 and apprived = 1 and ApprovedDisposal = 1 and assetunit = '$assetunit' and LEFT(disposedDate, 4) = '$currentYear' order by identificationno";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
	...
	public static function Save_fundtype($fundtype, $identificationno) {
        $db = Database::getDB();
		$query = "UPDATE officeequdetails SET fundtype = '$fundtype' WHERE identificationno ='$identificationno'";
        $count = $db->exec($query);
        return $count;
		}
    ...
    public static function getItemsNotTransfered_unit($assetunit, $fundtype) {
		...
		$querytext = Database::unitsFilter($querytext);
		$query = "SELECT identificationno, id, assetunit, assetscenter FROM officeequdetails WHERE".$querytext." order by protocolOrder, identificationno";
		try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function getDetailsGroupID($groupId) {
        $db = Database::getDB();
        $query = "SELECT * FROM officeequdetails WHERE groupID = '$groupId' order by counterId";
        try {
            $statement = $db->prepare($query);
            $statement->execute();
            $result = $statement->fetchAll();
    ...
    public static function approve_save_new($groupId) {
		...
		$query = "UPDATE officeequdetails SET apprived = 1, approvedPerson = '$login', notapprived = 0, notapprivedReason = '', apprivedDate = now() WHERE groupId ='$groupId'";
        $count = $db->exec($query);
        return $count;
    }
    public static function not_approve_save_new($groupId, $notapprivedReason) {
        $db = Database::getDB();
		$login = $_SESSION['SESS_LOGIN'];
        $query = "UPDATE officeequdetails SET notapprived = 1, notapprivedReason = '$notapprivedReason', approvedPerson = '$login', apprivedDate = now() WHERE groupId ='$groupId'";
        $count = $db->exec($query);
        return $count;
    }	
}
