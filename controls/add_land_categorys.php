                                ...
                                <div class="sct_right">
                                    <ul class="system_messages">
                                        ...
                                        switch ($error) {
                                            ...
                                            case '3':
                                                ?>
                                                <li class="yellow"><span class="ico"></span><strong class="system_title">Assets Land Category Already Entered !</strong></li>
                                                <?php
                                                break;
                                            case '5':
                                                ?>
                                    ...
                                    <form name="frm_add" method="post" id="frm_add" action="index.php" class="search_form general_form"> 
                                        <input type="hidden" name="action" value="Add_Land_Category" />
                                        
                                        <table width="100%" border="0">
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    <tr>
                                                        <td width="30%"><label>Land Category :</label></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php echo "Add Land Category Details";?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
												...
												<div class="table_wrapper">
													<div class="table_wrapper_inner">
														...
														<tr class=<?php if ($i % 2) {
															...
															<input type="hidden" name="action" value="Delete_Land_Category" />
