...
<div hidden class="section table_section">
	...
	<form name="add_form" id="add_form" class="add_form" action="." method="post">									
		<input type="hidden" name="action" id="action" value="unit_disband_undo"/>
		<input type="hidden" name="unit" id="unit" value="<?php echo $unit; ?>"/>
		<input class = "savebttn" id = "disband_all_undo" name="disband_all_undo" type="submit" value="Undo Disband" onclick="if (!confirm('Are you sure? Undo Disband this Unit.')) { return false }"/>
	</form>
    </div>
</div>
            ...
            <li id="1">
                ...
                <ul>
					...
					<li data-options="state:'closed'" id="2">                        
						...
						<ul>
                            <li><a href="index.php?action=unit_disband_undo&type=4&unit=<?php echo $exp['unitName']; ?>" onclick="return confirm('Are you sure ? You Want to Disband This Unit.')"><?php echo $exp['unitName']; ?></a></li>
                        </ul>
                       <?php 
