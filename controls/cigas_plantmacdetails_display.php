...
<div id="sec_menu">
<?php
echo "<a href='index.php?action=cigas_plantmacdetails_display&csv=csv&page1=$page1' class='paging'>Convert to CSV</a>";
echo "<a href='index.php?action=cigas_plantmacdetails_display&csv_all=csv_all&page1=$page1' class='paging'>Convert All to CSV</a>";
echo "<a href='index.php?action=cigas_plantmacdetails_display&exp_dot=exp_dot&page1=$page1' class='paging'>Convert to CSV With Dot</a>";
 ?>  
</div>
<script>	
...
<?php
echo "<a href='index.php?action=cigas_plantmacdetails_display&page1=1' class='paging'>First Page</a>";
