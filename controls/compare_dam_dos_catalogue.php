...
$("#savebttn").click(function(){
	var dos_catalogueno= $("#scale_catalogueno").prop('value');
	var dam_catalogueno= $("#dam_catalogueno").prop('value');
	var querystring = {
			dam_catalogueno: dam_catalogueno,
			dos_catalogueno: dos_catalogueno, 			
			action: 'compare_dam_dos_catalogue_save'
		}
...
<div id="page">
    <div class="section table_section">
        <form action="." method="post" id="search_Expendable__form">
            <input type="hidden" name="action" value="compare_dam_dos_catalogue"/>
											...
											<tbody>
                                                        ...
                                                        <?php foreach ($items as $exp) { ?>																
                                                            <tr class="nr">
																...
																<td><?php echo $exp['dos_catalogueno']; ?></td> 																
                                                            </tr>
                                                            <?php $i++; ?>
                                                        <?php } ?> 
                                                        </tbody></table>
