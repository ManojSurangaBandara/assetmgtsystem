                            ...
                            <div class="sct_left">
                                <div class="sct_right">
                                    ...
                                    <form name="frm_add" method="post" id="frm_add" action="index.php" class="search_form general_form"> 
                                        <input type="hidden" name="action" value="Change_AssetYear" />

                                        <table width="100%" border="0">
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    <tr>
                                                        <td width="30%"><label>Assets Year :	</label></td>
                                                        <td width="70%"><input type="text" class="text" name="currentYear"  id="currentYear" value="<?php echo $currentYear; ?>" style="width:50px"/>
                                                         </td>
                                                    </tr>
                                                    <tr>
                                                        <td><label> </label></td>
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php echo "Add Asset Year"; ?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
