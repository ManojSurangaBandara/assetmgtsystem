                                            ...
                                            <td colspan="3">
                                                <table width="100%" border="0" class="listing form">
                                                    <tr>
                                                        ...
                                                        <td width="70%">
                                                            <input type="text" class="text" name="instAddress"  id="instAddress" value="<?php echo $instAddress; ?>" style="width:400px"/>
													 ...
													 <tr>
                                                        ...
                                                        <td width="70%">
                                                            <input type="text" class="text" name="instTele"  id="instTele" value="<?php echo $instTele; ?>" style="width:300px"/>
													...
													<tr>
                                                        ...
                                                        <td width="70%">
                                                            <input type="text" class="text" name="instEmail"  id="instEmail" value="<?php echo $instEmail; ?>" style="width:300px"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="buttons">
                                                                <ul>
                                                                    <li><span class="button send_form_btn"><span><span><?php echo "Add Institute Details";?></span></span><input name="" type="submit"/></span> </li>
                                                                </ul>       
                                                            </div>
