									...
									<div id="nav">
                                        <ul class="sidebar_menu" id="sidebar1">
                                            ...
                                            switch ($slidebartype) {
												...
												case 12:
                                                    ?>
                                                    <li><a href="?index.php&action=Approved_Ajax"><?php echo $slideBar[3][$lang]?></a></li> 
                                                    <li><a href="?index.php&action=Tobe_Approve_Ajax"><?php echo $slideBar[2][$lang]?></a></li>
                                                    <?php
                                                    break;
                                                case 1:
                                                    if (empty($Items)) {
												...
												case 27:
												?>
														<li ng-repeat="x in $scope.NotApproved">
														  {{ x }}
														</li>                                                     
												...
												case 30:
														...
														<li <?php if ($_SESSION['SESS_LEVEL'] > 5){ echo 'hidden' ;}?>><a href="?index.php&action=List_summary6">Group By Land Category to Date (Ignore Units)</a></li> 
														 <?php                                                     
                                                    break;
												case 31:
                                                    if (empty($Items)) {
                                                    ...
                                                    foreach ($Items as $Item) :
                                                        ?>
                                                        <li><a href="index.php?action=ApprovedList&identificationno=<?php echo $Item['identificationno']; ?>&slidebartype=31&category=<?php echo $category;?>&acquisitiondate=<?php echo $acquisitiondate;?>" title="<?php echo $Item['identificationno']; ?>"><?php echo $Item['identificationno']; ?> </a></li>            
                                                    <?php endforeach; ?>
                                                    <?php
                                                    }
                                                    break;
