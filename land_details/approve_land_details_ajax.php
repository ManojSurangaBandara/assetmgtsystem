    ...
    <div class="inner">
        <div class="section">
            <div class="title_wrapper" id="title">
                <span><h2>Approve Land Details</h2></span>
                                ...
                                <div class="sct_right">
									...
									<?php } ?>
														<label class="label"><?php echo $tList[0][$lang]?></label>
                                                            <div> <input type="text" class="text" name="assetscenter"  id="assetscenter" value="<?php echo $assetscenter; ?>" style="width:200px; background-color:white; color: black" disabled/></div> 
                                                        <label class="label"><?php echo $tList[1][$lang]?></label>
                                                            <div> <input type="text" class="text" name="assetunit"  id="assetunit" value="<?php echo $assetunit; ?>" style="width:200px; background-color:white; color: black" disabled/></div> 
									...
									<?php } else if ($displaytype == 2) {?>
									 ...
									 <?php } ?>          
													...
													<input type="submit" name="submit" id="submit" value="Approve Details">
												</div> 
												<label class="label"><?php echo $tList[23][$lang]?></label>
												<div><input type="text" class="text" name="notapprivedReason"  id="notapprivedReason" value="<?php echo $notapprivedReason; ?>" style="width:400px;" /></div>
													<div>
													<input type="submit" name="submit" id="update" value="Not Approve Details">
												</div> 
                                    </form>                                    
                                </div>
                            </div>
