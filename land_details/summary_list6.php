...
<td style="color: black;"><nobr><a href="index.php?action=List_summary_6_list&id=1&category=<?php echo $exp[0]; ?>&acquisitiondate=<?php echo $acquisitiondate; ?>"><?php echo $exp[0]; ?></a></nobr></td>	
