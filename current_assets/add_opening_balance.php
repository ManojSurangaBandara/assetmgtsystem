...
<div id="page">
	<div class="title_wrapper">
		<h2><span id ="heading1">ADD -</span> Opening Balance</h2>
				...
				<?php $i = 1; 
				   ...
				   ?>																
						...
						<tr>
							...
							<td style="background-color: #C4EEFF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_onhand'], 2, ".", "")); ?>" id="qty_onhand_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #BDEBFF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_q1'], 2, ".", "")); ?>" id="qty_q1_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #B5E9FF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_q2'], 2, ".", "")); ?>" id="qty_q2_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #ABE6FF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_q3'], 2, ".", "")); ?>" id="qty_q3_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #A2E3FF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_q4'], 2, ".", "")); ?>" id="qty_q4_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #99E1FF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_q5'], 2, ".", "")); ?>" id="qty_q5_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);"></nobr></td>
							<td style="background-color: #8CDDFF;"><nobr><input class = "sname" type="text" value="<?php echo str_replace(".00", "", (string)number_format ($exp['qty_ledger'], 2, ".", "")); ?>" id="qty_ledger_<?php echo $exp['id']; ?>" style="text-align: right; font-family: courier;font-size:14px; font-weight:bold;" size="8" onClick="this.select();" onkeypress="return isNumberKey(event);" readonly></nobr></td>
